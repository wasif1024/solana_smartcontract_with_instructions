...
export async function checkProgram(): Promise<void> {
  ...
  //let generatedProgramId:string="BA9oo82fcGGtcmgFeshoGptqicbDuN9aiaez1zxEjADp";
  try {
...
export async function sayHello(): Promise<void> {
  ...
  //let bufferObj = creatIncreamentInstruction();
